...
const SkillsList = () => {
  ...
  return (
    <Box bg={useColorModeValue("#edf2f7", "#0f1624")} border={"0px solid blue"}>
      <Tabs variant="unstyled" align="center">
        <TabList my={5}>
          <Tab
            fontWeight={700}
            _selected={{ color: "red", borderBottom: "1px solid red" }}
            mx={3}
          >
            All
          </Tab>
        ...
        <TabPanels>
          <TabPanel paddingBottom="100px" border={"0px solid red"}>
            <Grid
              templateColumns={{
                base: "repeat(2, 1fr)",
                sm: "repeat(2, 1fr)",
