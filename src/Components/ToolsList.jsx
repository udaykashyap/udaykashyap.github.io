...
export const ToolsData = [
  ...
  {
    icon: "https://www.katk.dev/static/86f2f48b9b0dd900b4892f49f4bbab81/e4f06/logo.png",
    name: "Thunder Client",
  },
  {
  ...
  {
    icon: "https://storage.googleapis.com/replit/images/1664936134487_bea5d042b009e30746581000d3dfae74.webp",
    name: "Replit",
  },
];
        ...
        <TabPanels>
          <TabPanel paddingBottom="100px" border={"0px solid red"}>
            <Grid
              ...
              //   gap={5}
            >
              {ToolsData.map((skill, i) => (
                <SkillCard border={"0px solid white"} key={i} {...skill} />
              ))}
            </Grid>
          </TabPanel>
        </TabPanels>
